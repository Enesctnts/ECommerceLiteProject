...
namespace ECommerceLiteBLL.Account.MembershipTools
{
    public static class MembershipTools
    {
        ...
        public static string GetNameSurname()
        {
            ...
            //string usernamesurname = ""; // aynı şey
            usernamesurname = user != null ?
                //string.Format("{0} {1}" , user.Name , user.Surname) //alttakiyle aynı şey
                //user.Name + " " + user.Surname // alttakiyle aynı şey 
